...
class LinkedBinaryTree:
    ...
    def iterative_inorder(self):
        ...
        def left_child(given_node):
            return given_node.parent.left is given_node

        def right_child(given_node):
            return given_node.parent.right is given_node
            ...
            if node.right is not None:
                ...
                if right_child(node):
                    ...
                    while cursor is not self.root:
                        cursor, node = node.parent, cursor
                        if cursor.left == node:
